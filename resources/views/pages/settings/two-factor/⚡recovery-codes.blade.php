            ...
            <div class="mt-3 space-y-3">
                ...
                @if (filled($recoveryCodes))
                    ...
                    <flux:text variant="subtle" class="text-xs">
                        Cada código de recuperación se puede usar una vez para acceder a tu cuenta y será eliminado después de usarse. Si necesitas más, haz clic en Regenerar Códigos arriba.
                    </flux:text>
                @endif
            </div>
        </div>
